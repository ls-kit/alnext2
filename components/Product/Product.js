    ...
    >
      ...
      <div className="p-1">
        ...
        <div className="flex justify-between items-center mt-2 mb-2">
          <span className="text-[#0e2954] font-bold text-base font-['Outfit']">
            ৳ {_.round(product.sale_price)}
          </span>
          <span className="text-xs font-['Outfit'] font-medium text-[#777] px-1">
